...
public class MovablePoint implements Movable{
    ...
    public MovablePoint(){this.x = 0; this.y = 0; this.speed = 1;}
    public MovablePoint(int x, int y){this.x = x; this.y = y; this.speed = 1;}
    public MovablePoint(int x, int y, int speed){this.x = x; this.y = y; this.speed = speed;}
